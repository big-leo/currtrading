...
INSERT INTO "django_migrations" VALUES(1,'contenttypes','0001_initial','2016-10-01 12:57:13.845474');
INSERT INTO "django_migrations" VALUES(2,'auth','0001_initial','2016-10-01 12:57:14.158511');
INSERT INTO "django_migrations" VALUES(3,'admin','0001_initial','2016-10-01 12:57:14.462683');
INSERT INTO "django_migrations" VALUES(4,'admin','0002_logentry_remove_auto_add','2016-10-01 12:57:14.784171');
INSERT INTO "django_migrations" VALUES(5,'contenttypes','0002_remove_content_type_name','2016-10-01 12:57:15.106361');
INSERT INTO "django_migrations" VALUES(6,'auth','0002_alter_permission_name_max_length','2016-10-01 12:57:15.394757');
INSERT INTO "django_migrations" VALUES(7,'auth','0003_alter_user_email_max_length','2016-10-01 12:57:15.691705');
INSERT INTO "django_migrations" VALUES(8,'auth','0004_alter_user_username_opts','2016-10-01 12:57:15.988131');
INSERT INTO "django_migrations" VALUES(9,'auth','0005_alter_user_last_login_null','2016-10-01 12:57:16.300799');
INSERT INTO "django_migrations" VALUES(10,'auth','0006_require_contenttypes_0002','2016-10-01 12:57:16.409926');
INSERT INTO "django_migrations" VALUES(11,'auth','0007_alter_validators_add_error_messages','2016-10-01 12:57:16.755423');
INSERT INTO "django_migrations" VALUES(12,'auth','0008_alter_user_username_max_length','2016-10-01 12:57:17.060170');
INSERT INTO "django_migrations" VALUES(13,'sessions','0001_initial','2016-10-01 12:57:17.364630');
INSERT INTO "django_migrations" VALUES(14,'rates','0001_initial','2016-10-01 13:53:12.614022');
...
INSERT INTO "django_content_type" VALUES(7,'rates','rate');
INSERT INTO "django_content_type" VALUES(8,'rates','currency');
...
INSERT INTO "auth_permission" VALUES(19,7,'add_rate','Can add rate');
INSERT INTO "auth_permission" VALUES(20,7,'change_rate','Can change rate');
INSERT INTO "auth_permission" VALUES(21,7,'delete_rate','Can delete rate');
INSERT INTO "auth_permission" VALUES(22,8,'add_currency','Can add currency');
INSERT INTO "auth_permission" VALUES(23,8,'change_currency','Can change currency');
INSERT INTO "auth_permission" VALUES(24,8,'delete_currency','Can delete currency');
CREATE TABLE "auth_user" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "password" varchar(128) NOT NULL, "last_login" datetime NULL, "is_superuser" bool NOT NULL, "first_name" varchar(30) NOT NULL, "last_name" varchar(30) NOT NULL, "email" varchar(254) NOT NULL, "is_staff" bool NOT NULL, "is_active" bool NOT NULL, "date_joined" datetime NOT NULL, "username" varchar(150) NOT NULL UNIQUE);
CREATE TABLE "django_session" ("session_key" varchar(40) NOT NULL PRIMARY KEY, "session_data" text NOT NULL, "expire_date" datetime NOT NULL);
CREATE TABLE "rates_currency" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(3) NOT NULL UNIQUE);
INSERT INTO "rates_currency" VALUES(3,'EUR');
INSERT INTO "rates_currency" VALUES(4,'USD');
INSERT INTO "rates_currency" VALUES(5,'CNY');
INSERT INTO "rates_currency" VALUES(6,'RUB');
CREATE TABLE "rates_rate" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "value" real NOT NULL, "curr_from_id" integer NOT NULL REFERENCES "rates_currency" ("id"), "curr_to_id" integer NOT NULL REFERENCES "rates_currency" ("id"));
INSERT INTO "rates_rate" VALUES(8,1.1,3,4);
INSERT INTO "rates_rate" VALUES(9,0.9,4,3);
INSERT INTO "rates_rate" VALUES(10,6.0,4,5);
INSERT INTO "rates_rate" VALUES(11,6.5,3,5);
INSERT INTO "rates_rate" VALUES(12,65.0,4,6);
INSERT INTO "rates_rate" VALUES(13,70.0,3,6);
INSERT INTO "rates_rate" VALUES(14,1.0,3,3);
INSERT INTO "rates_rate" VALUES(15,1.0,4,4);
INSERT INTO "rates_rate" VALUES(16,1.0,5,5);
INSERT INTO "rates_rate" VALUES(17,1.0,6,6);
...
INSERT INTO "sqlite_sequence" VALUES('rates_currency',6);
INSERT INTO "sqlite_sequence" VALUES('rates_rate',17);
...
CREATE INDEX "rates_rate_976dfcd1" ON "rates_rate" ("curr_from_id");
CREATE INDEX "rates_rate_0ee29927" ON "rates_rate" ("curr_to_id");
COMMIT;
